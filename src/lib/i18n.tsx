...
const translations = {
  sv: {
    ...
    // Reset Password
    'resetPassword.title': 'Skapa nytt lösenord',
    'resetPassword.description': 'Ange ditt nya lösenord nedan.',
    ...
    'resetPassword.passwordHint': 'Minst 8 tecken',
    'resetPassword.resetButton': 'Återställ lösenord',
    'resetPassword.resetting': 'Återställer...',
    'resetPassword.success': 'Lösenord uppdaterat!',
    'resetPassword.successDesc': 'Ditt lösenord har ändrats.',
    'resetPassword.successTitle': 'Lösenordet har återställts',
    'resetPassword.successMessage': 'Ditt lösenord har uppdaterats. Du kan nu logga in med ditt nya lösenord.',
    'resetPassword.goToLogin': 'Gå till inloggning',
    'resetPassword.error': 'Något gick fel',
    'resetPassword.errorDesc': 'Kunde inte återställa lösenordet. Försök igen.',
    'resetPassword.passwordMismatch': 'Lösenorden matchar inte',
    'resetPassword.passwordMismatchDesc': 'Kontrollera att båda lösenorden är identiska.',
    'resetPassword.passwordTooShort': 'Lösenordet är för kort',
    'resetPassword.passwordTooShortDesc': 'Lösenordet måste vara minst 8 tecken.',
    'resetPassword.secureTitle': 'Säker inloggning',
    'resetPassword.secureDescription': 'Välj ett starkt lösenord för att skydda ditt konto.',
  ...
  en: {
    ...
    'resetPassword.passwordHint': 'At least 8 characters',
    'resetPassword.resetButton': 'Reset password',
    'resetPassword.resetting': 'Resetting...',
    'resetPassword.success': 'Password updated!',
    'resetPassword.successDesc': 'Your password has been changed.',
    'resetPassword.successTitle': 'Password has been reset',
    'resetPassword.successMessage': 'Your password has been updated. You can now log in with your new password.',
    'resetPassword.goToLogin': 'Go to login',
    'resetPassword.error': 'Something went wrong',
    'resetPassword.errorDesc': 'Could not reset password. Please try again.',
    'resetPassword.passwordMismatch': 'Passwords do not match',
    'resetPassword.passwordMismatchDesc': 'Please make sure both passwords are identical.',
    'resetPassword.passwordTooShort': 'Password too short',
    'resetPassword.passwordTooShortDesc': 'Password must be at least 8 characters.',
    'resetPassword.secureTitle': 'Secure Login',
    'resetPassword.secureDescription': 'Choose a strong password to protect your account.',
